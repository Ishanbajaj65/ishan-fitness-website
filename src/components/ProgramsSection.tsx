  ...
  return (
    <div id="blueprints" className="space-y-16 text-left">
      <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-primary text-center uppercase mb-16 font-black tracking-tight">
        TRAINING <span className="text-[#e11d48]">BLUEPRINTS</span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <div className="w-12 h-12 rounded-full bg-[#e11d48]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <button 
            ...
            className="ghost-btn w-full py-3 font-mono font-bold text-xs uppercase rounded hover:bg-[#e11d48] hover:text-black transition-colors"
          >
            EXPLORE PROTOCOL
          </button>
        </motion.div>
        ...
        <motion.div 
          whileHover={{ translateY: -5 }}
          className="glass-card glass-card-active rounded-xl p-8 flex flex-col group relative overflow-hidden border border-[#e11d48]"
        >
          <div className="absolute top-0 right-0 px-3 py-1 bg-[#e11d48] text-black font-mono text-[9px] uppercase font-black rounded-bl-lg tracking-widest">
            POPULAR
          </div>
          <div className="w-12 h-12 rounded-full bg-[#e11d48]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <span className="material-symbols-outlined text-[#e11d48]" style={{ fontVariationSettings: "'FILL' 1" }}>
